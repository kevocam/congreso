<div class="auditorioBlue">
    ...
    <div class="auditorioBlue__pantalla animation-player">
      ...
      <iframe src="https://www.youtube-nocookie.com/embed/G2ZcYnjVmI4?modestbranding=1&rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        ...
        <div class="auditorioBlue__cartelRight--item">
            <div class="cartelCustom__item--top">
             ...
             <div class="cartelCustom__item--bottom">
                ...
                <a href="../pdf/programas/programa-auditorio2.pdf" target="_blank" >
    ...
    <div class="auditorioBlue__question">
        <div class="auditorioBlue__question--item" >   
              @livewire('questions' , ['auditorio' => 2])
        </div>
     </div> 
