<div class="dominicana">
    <div class="dominicana__bannerAzul animation-cartelLeft">
        <div class="dominicana__bannerAzul--item">

        </div>
    </div>
    <div class="dominicana__bannerLogo animation-bannerFlip">
        <div class="dominicana__bannerLogo--item">

        </div>
    </div>
    <div class="dominicana__tv  animation-player">
        <div class="dominicana__tv--item">

        </div>
    </div>
    <div class="dominicana__bannerNormal animation-cartelRight ">
        <div class="dominicana__bannerNormal--item">
