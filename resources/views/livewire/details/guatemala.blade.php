<div class="guatemala">
    ...
    <div class="guatemala__panel  animation-bannerFlip">
        <div class="guatemala__panel--item">

        </div>
    </div>
    <div class="guatemala__banner  animation-bannerFlip">
        <div class="guatemala__banner--item">
        
        </div>    
    </div>
    <div class="guatemala__cartelUp animation-bannerUp">
        <div class="guatemala__cartelUp--item">

        </div>
    </div>
    <div class="guatemala__cartelRight animation-top ">
        <div class="guatemala__cartelRight--item">
