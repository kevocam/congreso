<div class="humanizando">
    <div class="humanizando__banner animation-bannerFlip">
        <div class="humanizando__banner--item">

        </div>
    </div>
    <div class="humanizando__tv animation-player">
        <div class="humanizando__tv--item">

        </div>
    </div>
    <div class="humanizando__cartel animation-cartelRight">
        <div class="humanizando__cartel--item">
