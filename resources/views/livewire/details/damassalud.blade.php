<div class="damassalud">

    <div class="damassalud__banner animation-bannerFlip">
        <div class="damassalud__banner--item">

        </div>
    </div>

    <div class="damassalud__tv animation-player">
        <div class="damassalud__tv--item">

        </div>
    </div>
    <div class="damassalud__cartel animation-cartelRight">
        <div class="damassalud__cartel--item">
