<div class="beauty">
    <div class="beauty__panel">
        <div class="beauty__panel--item">

        </div>
    </div>
    <div class="beauty__bannerLeft">
        <div class="beauty__bannerLeft--item">

        </div>

    </div>
    <div class="beauty__tv">
        <div class="beauty__tv--item">

        </div>
    </div>
    <div class="beauty__bannerRight">
        <div class="beauty__bannerRight--item">
