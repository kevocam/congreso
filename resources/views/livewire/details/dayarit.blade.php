<div class="gray">   
    <div class="gray__panel animation-bannerFlip">
        <div class="gray__panel--item">
                
        </div>
    </div>
    <div class="gray__banner animation-bannerFlip">
        <div class="gray__banner--item">
            
        </div>
    </div>

    <div class="gray__cartelUp animation-bannerUp">
        <div class="gray__cartelUp--item">
        </div>
    </div>
    <div class="gray__cartelRight animation-top ">
        <div class="gray__cartelRight--item">
